    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-header col-md-15 mb-4">
                ...
                <div class="col-sm-8">
                    <h3 class="card-title">รายการวัสดุงานบ้านทั้งหมด</h3>
                </div>
            ...
            <div class="card-body p-0">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        WHERE ( met_name LIKE '%$material_name%' AND meter.met_total>='1'AND meter.met_mtype='6') ORDER BY meter.met_name ASC";
